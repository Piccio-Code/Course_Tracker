...
import { User, Mail, Save, X, Camera, Loader2 } from 'lucide-react';
                    ...
                    <div className="p-8">
                        <div className="flex items-start justify-between mb-8">
                                ...
                                <div className="relative group">
                                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 p-1">
                                        <div className="w-full h-full rounded-full bg-[#161b22] flex items-center justify-center border-4 border-[#161b22] overflow-hidden">
                                            <span className="text-3xl font-bold text-white uppercase">{formData.username.substring(0,2)}</span>
                                        </div>
                                    </div>
                            ...
                            {!isEditing && (
                                <button
                                    onClick={() => {
                                        setFormData(user); // Ensure form starts with current data
                                        setIsEditing(true);
                                    }}
